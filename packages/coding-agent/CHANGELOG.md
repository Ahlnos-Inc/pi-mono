...
- Fixed interactive prompts rendering only after input extensions finished, so slow preflight hooks no longer make submitted text appear stuck in the editor.
